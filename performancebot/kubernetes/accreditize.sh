...
cat postgrest-rc.json.in | sed "s/\$DBHOST/$DBHOST/g" | sed "s/\$DBPORT/$DBPORT/g" | sed "s/\$DBNAME/$DBNAME/g" | sed "s/\$DBUSER/$DBUSER/g" | sed "s/\$DBPASS/$DBPASS/g" >postgrest-rc.json
#  | sed "s/\$EC2_SLAVE1/$EC2_SLAVE1/g" | sed "s/\$EC2_SLAVE2/$EC2_SLAVE2/g"
