...
namespace Benchmarks.Health
{
	 ...
	 **/
		...
		{
			logger.InfoFormat ("usage: java Health -l <levels> -t <time> -s <seed> [-p] [-m] [-h]");
			logger.InfoFormat ("    -l the size of the health care system");
			logger.InfoFormat ("    -t the amount of simulation time");
			logger.InfoFormat ("    -p (print results)");
