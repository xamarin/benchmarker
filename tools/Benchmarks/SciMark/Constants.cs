...
namespace Benchmarks.SciMark
{
	public class Constants
	{
		...
		public const double RESOLUTION_DEFAULT = 2.0;
		/*secs*/
		...
		//
		public const int LG_FFT_SIZE = 1048576;
		// must be a power of two
		public const int LG_SOR_SIZE = 1000;
		// NxN grid
		...
		//
		public const int TINY_FFT_SIZE = 16;
		// must be a power of two
		public const int TINY_SOR_SIZE = 10;
		// NxN grid
